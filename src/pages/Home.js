          ...
          <div className="about-us p-4" style={{ border: "10" }}>
            ...
            <p>
              ...
              <p>
                ...
                global players, every month. Tax Doctor is a firm with "One Stop
                Solution" policy for its clients, where we are delivering a wide
                range of business advisory services. We assist our clients and
                their businesses, organizations with tax strategy, planning and
                compliance. We help Organizations work smarter and grow faster,
                reach out to us to build effective organizations, reduce costs,
                manage risk and regulations and leverage talent. We help
                companies maximize value during these moments of exceptional
                change. With a global network of trusted advisors, we support
                companies with their accounting, financial reporting and
                valuation needs. Our practitioners combine accounting, valuation
                and tax expertise to help you preserve the value of your
                business. At Tax Doctor we strongly believe in establishing long
                term relationship with the clients. To us every client is
                equally important and when they repose their trust in us, it
                becomes our bounden duty to serve them with utmost care and the
                highest level of professional competence. We accept the fact
                that we are not the largest firm nor do we have a global
                presence, but our team is like a family. Every member of the
                team at Tax Doctor is encouraged to be friendly, professional
                and fully committed to delivering the best service. Our strength
                lies in our versatility – wherein you would experience being
                served personally by a senior member as if you have engaged the
        ...
        <div className="col-lg-6">
          <div className="gmaps p-4">
            <div className="location-heading mb-4">
              <h2 style={{ marginBottom: "10px" }}>Our Locations</h2>
            </div>
            <div className="location-map">
              <p
                style={{ padding: "10px", fontFamily: "", fontWeight: "bold" }}
              >
                Samakhusi address
              </p>
              <iframe
